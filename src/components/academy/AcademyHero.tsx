...
import { ACADEMY_HERO } from '@/lib/academy-data';
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="text-center md:text-left flex-1">
            ...
            <h1 className="text-3xl md:text-5xl font-black mb-6 leading-tight italic">
                {ACADEMY_HERO.title_1} <br className="hidden md:block" /> {ACADEMY_HERO.title_2} 
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-300">
                    {ACADEMY_HERO.title_highlight}
                </span>
            </h1>
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
                <div className="text-right border-r border-slate-800 pr-4">
                    <p className="font-bold text-white text-sm">{ACADEMY_HERO.author}</p>
                    <p className="text-[10px] text-slate-500 uppercase tracking-widest">{ACADEMY_HERO.role}</p>
                </div>
